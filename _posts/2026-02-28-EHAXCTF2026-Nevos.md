...
![normal_behaviour_remote.PNG](../../../assets/img/posts/2026-03-03-womp-womp/normal_behaviour_remote.PNG)
...
nm -D ./libcoreio.so
```
{% include figure.liquid loading="eager" path="assets/img/posts/2026-03-03-womp-womp/reconnaissance.png"
...
```
{% include figure.liquid loading="eager" path="assets/img/posts/2026-03-03-womp-womp/disass_emit_report_partly.png"
class="img-fluid rounded z-depth-1" max_width="500px"%}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2026-03-03-womp-womp/disass_submit_note.png"
class="img-fluid rounded z-depth-1" max_width="500px"%}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2026-03-03-womp-womp/disass_review_note.png"
class="img-fluid rounded z-depth-1" max_width="500px"%}
...
```
{% include figure.liquid loading="eager" path="assets/img/posts/2026-03-03-womp-womp/disass_finalize_entry.png"
class="img-fluid rounded z-depth-1" max_width="500px"%}
...
{% include figure.liquid loading="eager" path="assets/img/posts/2026-03-03-womp-womp/finding_ROP_Gadgets.png"
class="img-fluid rounded z-depth-1" max_width="500px"%}
...
## Flag Capture
{% include figure.liquid loading="eager" path="assets/img/posts/2026-03-03-womp-womp/flag.png"
class="img-fluid rounded z-depth-1" max_width="500px"%}
